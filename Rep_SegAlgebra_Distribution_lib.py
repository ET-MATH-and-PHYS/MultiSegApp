...
# This file was *autogenerated* from the file Rep_SegAlgebra_Distribution2.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_12 = Integer(12); _sage_const_1000 = Integer(1000)
import numpy as np
...
class Segment:
    ...
    def subtract(self):
        ...
        if not self.empty:
            self.seg_upper = self.seg_upper - _sage_const_1 
            if self.seg_upper < self.seg_lower:
                self.empty = True
                self.seg_upper, self.seg_lower = _sage_const_0 , _sage_const_0 
...
class Multisegment:
    ...
    def plot_poset(self):
        ...
        p_plot = pos.plot(figsize=_sage_const_12 , element_shape = "None", element_size = _sage_const_1000 , title = repr(self) + " Poset Tree")
        show(p_plot)
...
def is_less_than(seg1, seg2):
    """
    Returns if seg2 is less than or equal to seg1
    """
    return seg2.greater_than(seg1)
...
def multi_segment(A):
    ...
    while (not np.all(A == _sage_const_0 )) and np.all(A >= _sage_const_0 ):
        ...
        ordering.extend([Segment(j+_sage_const_1 , n-i) for l in range(int(k))])
...
def rank_triag(multi_seg, row_num):
    ...
    for segment in multi_dict.keys():
        j = segment.get_segment_lower()-_sage_const_1  # Column index for tip of triangle
